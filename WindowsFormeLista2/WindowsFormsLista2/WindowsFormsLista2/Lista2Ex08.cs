    ...
    public partial class Lista2Ex08 : Form
    {
        ...
        private void maskedTextBox1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                DialogResult confirm = MessageBox.Show("Você tem certeza que e a opcão: "+ Opcao, "Salvar Pedido", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button2);
